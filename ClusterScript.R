...
write.table(Cluster1, file = "Cluster1.csv", sep = ",", row.names = FALSE)
write.table(Cluster2, file = "Cluster2.csv", sep = ",", row.names = FALSE)
write.table(Cluster3, file = "Cluster3.csv", sep = ",", row.names = FALSE)
write.table(Cluster4, file = "Cluseter4.csv", sep = ",", row.names = FALSE)
write.table(Cluster5, file = "Cluster5.csv", sep = ",", row.names = FALSE)
write.table(Cluster6, file = "Cluster6.csv", sep = ",", row.names = FALSE)
write.table(Cluster7, file = "Cluster7.csv", sep = ",", row.names = FALSE)
write.table(Cluster8, file = "Cluster8.csv", sep = ",", row.names = FALSE)
write.table(Cluster9, file = "Cluster9.csv", sep = ",", row.names = FALSE)
write.table(Cluster10, file = "Cluster10.csv", sep = ",", row.names = FALSE)
write.table(Cluster11, file = "Cluster11.csv", sep = ",", row.names = FALSE)
write.table(Cluster12, file = "Cluster12.csv", sep = ",", row.names = FALSE)
write.table(Cluster13, file = "Cluster13.csv", sep = ",", row.names = FALSE)
write.table(Cluster14, file = "Cluster14.csv", sep = ",", row.names = FALSE)
write.table(Cluster15, file = "Cluster15.csv", sep = ",", row.names = FALSE)